...
struct ConfigTests {
    ...
    func inMemoryTokens() throws {
        ...
        try store.writeToken("wit_dev_one")
        try store.writeToken("wit_dev_two")
    ...
    @Test("The Keychain item is addressed by the Witness service and account")
    func keychainQuery() {
    ...
    func environmentToken() throws {
        ...
        try environment.writeToken("wit_dev_SYNTHETIC")
        #expect(throws: EnvironmentTokenError.differentToken) { try environment.writeToken("wit_dev_OTHER") }
